...
function renderSidebar() {
    ...
    const menuItems = [
        { name: "Dashboard", icon: "bi-speedometer2", href: "dashboard.html", roles: ["admin", "vice", "leader", "assistant"] },
        ...
        { name: "Lộ trình & Timeline", icon: "bi-diagram-3", href: "timeline.html", roles: ["admin", "vice", "leader", "assistant"] },
        ...
        { name: "Lịch công tác", icon: "bi-calendar3", href: "calendar.html", roles: ["admin", "vice", "leader", "assistant"] },
        { name: "Quản lý Sự kiện", icon: "bi-calendar-event", href: "events.html", roles: ["admin", "vice", "leader", "assistant", "member", "guest"] },
        { name: "Kho minh chứng", icon: "bi-folder2-open", href: "evidence.html", roles: ["admin", "vice", "leader", "assistant"] },
