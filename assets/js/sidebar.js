...
function renderSidebar() {
    ...
    const menuItems = [
        { name: "Dashboard", icon: "bi-speedometer2", href: "dashboard.html", roles: ["admin", "vice", "treasurer", "leader", "assistant"] },
        { name: "Không gian của tôi", icon: "bi-laptop", href: "workspace.html", roles: ["admin", "vice", "treasurer", "leader", "assistant", "member", "guest"] },
        { name: "Giới thiệu CLB", icon: "bi-info-circle", href: "about.html", roles: ["admin", "vice", "treasurer", "leader", "assistant", "member", "guest"] },
        { name: "Lộ trình & Timeline", icon: "bi-diagram-3", href: "timeline.html", roles: ["admin", "vice", "treasurer", "leader", "assistant"] },
        { name: "Quản lý Thành viên", icon: "bi-people", href: "members.html", roles: ["admin", "vice", "treasurer", "leader"] },
        { name: "Quản lý Ban", icon: "bi-building", href: "departments.html", roles: ["admin", "vice"] },
        { name: "Quản lý Quỹ CLB", icon: "bi-wallet2", href: "funds.html", roles: ["admin", "vice", "treasurer", "leader", "assistant", "member", "guest"] },
        { name: "Quản lý Công việc", icon: "bi-list-check", href: "tasks.html", roles: ["admin", "vice", "treasurer", "leader", "assistant", "member", "guest"] },
        { name: "Lịch công tác", icon: "bi-calendar3", href: "calendar.html", roles: ["admin", "vice", "treasurer", "leader", "assistant"] },
        { name: "Quản lý Sự kiện", icon: "bi-calendar-event", href: "events.html", roles: ["admin", "vice", "treasurer", "leader", "assistant", "member", "guest"] },
        { name: "Kho minh chứng", icon: "bi-folder2-open", href: "evidence.html", roles: ["admin", "vice", "treasurer", "leader", "assistant"] },
        { name: "Thông báo", icon: "bi-bell", href: "notifications.html", roles: ["admin", "vice", "treasurer", "leader", "assistant", "member", "guest"] },
